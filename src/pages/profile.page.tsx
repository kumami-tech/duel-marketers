...
const profileItemList = [
  ...
  },
  {
    ...
    description: [
      ...
      "卒業後は地方銀行に入行し約 3 年間、個人融資窓口や法人渉外係等に従事。",
      "2022 年 1 月よりWebディレクターの統括管理やWebディレクターとしてコンテンツ作成に携わっております。",
      "現在では銀行員として培った提案力とディレクション経験をもとに、",
      "SEO 内部・外部対策やコンテンツマーケティング・サイト解析による",
      "顧客サイト価値の向上から実際に顧客獲得施策に至るまで、",
      "一気通貫して対応し、より顧客に寄り添った Web マーケティング施策のご提案が可能です。",
    ].join("\n"),
  },
  {
    icon: <LampIcon />,
